	...
	<view class="container">
		...
		<view class="coupon-list">
			<view class="coupon-item" v-for="(item,index) in couponList" :key="index">
				<view class="coupon">
					<image src="../../static/images/index/img_fuwuquan_blue.png" class="coupon-img"></image>
					...
					<view class="right-detail" @tap="spread" :data-index="index">
						...
						<image :src="'../../static/images/index/'+(item.spread?'home_icon_choose':'icon_next')+'.png'" :class="[item.spread?'spread':'arrow']"></image>
					</view>
				</view>
